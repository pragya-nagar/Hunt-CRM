...
{
    public class GetCampaignCommentAuthorIdQuery : SingleQuery<Guid, Guid?>
    {
        private readonly ISynergyContext _context;

        public GetCampaignCommentAuthorIdQuery(ISynergyContext context)
        {
        ...
        {
            var comment = await this._context.CampaignComment
