...
{
    public class OpportunityUpdateArgsValidator : AbstractValidator<OpportunityUpdateArgs>
    {
        public OpportunityUpdateArgsValidator()
        {
            ...
            this.RuleForEach(x => x.Borrowers)
                .NotNull()
                .SetValidator(new UpdateBorrowerValidator())
                .When(x => x.OpportunityPropertyTypeId != (int)OpportunityPropertyType.CommercialEntityOwned);
            ...
            this.RuleForEach(x => x.CommercialBorrowers)
                .NotNull()
                .SetValidator(new UpdateCommercialBorrowerValidator())
                .When(x => x.OpportunityPropertyTypeId == (int)OpportunityPropertyType.CommercialEntityOwned);
        }
    }
}